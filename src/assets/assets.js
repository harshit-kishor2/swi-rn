...
const fontsConst = {
  ...
  Cabin_BoldItalic: 'Cabin-BoldItalic',
  Cabin_Italic: 'Cabin-Italic',
  Cabin_Medium: 'Cabin-Medium',
  Cabin_MediumItalic: 'Cabin-MediumItalic',
  Cabin_Regular: 'Cabin-Regular',
  Cabin_SemiBold: 'Cabin-SemiBold',
...
export {assetsConst as AssestsConst, fontsConst as FontsConst};
