                ...
                <View style={{ margin: 15 }}>
                    ...
                    <View style={{ marginTop: 10, marginVertical: 5 }}>
                        <Text style={{
                            ...
                            You reached +6.9% more
                            clicks in the last 7 days
                            as compared to May 30- June 5
                        </Text>
                    </View>
                    ...
                    <View style={{ marginVertical: 10 }}>
                        ...
                        <View style={{ height: 2, backgroundColor: '#D8D8D8', marginTop: 6 }} />
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 }}>
                    ...
                    <View style={{
                        ...
                        <View style={{ width: '30%' }}>
                            <TouchableOpacity>
                                <Text style={[style.OpacityText, select === 'Impressions' && style.OpacityTextHighlighted]} onPress={() => setSelect('Impressions')} >Impressions</Text>

                            </TouchableOpacity>
                            {select === 'Impressions' ? <View style={{ height: 4, backgroundColor: '#00958C', marginTop: 10 }} /> : null}

                        </View>

                        <View style={{ width: '30%' }}>
                            <TouchableOpacity>
                                <Text style={[style.OpacityText, select === 'Clicks' && style.OpacityTextHighlighted]} onPress={() => setSelect('Clicks')}>Clicks</Text>

                            </TouchableOpacity>
                            {select === 'Clicks' ? <View style={{ height: 4, backgroundColor: '#00958C', marginTop: 10 }} /> : null}
                        </View>

                        <View style={{ width: '30%' }}>
                            <TouchableOpacity>
                                <Text style={[style.OpacityText, select === 'Chats' && style.OpacityTextHighlighted]} onPress={() => setSelect('Chats')}>Chats</Text>

                            </TouchableOpacity>
                            {select === 'Chats' ? <View style={{ height: 4, backgroundColor: '#00958C', marginTop: 10 }} /> : null}
                        </View>
                    </View>
                    <View style={{
