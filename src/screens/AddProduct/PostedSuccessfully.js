        ...
        <StoryScreen>
            ...
            <View>
                ...
                <View>
                    ...
                    <Text style={styles.text}>Your post is now visible to the customers</Text>
                    <Text style={styles.text1}>You can boost your
                        post to get higher visibility
                        and get attractions</Text>
                ...
                <Text
                  style={{ fontSize: 14, color: '#00958C', fontFamily: 'Open Sans', textDecorationLine:'underline' }}
                  onPress={() => {
            ...
            <View>
                ...
                <Text style={styles.text}>If you want to make any changes to your post you can do that from your posted ads section.
